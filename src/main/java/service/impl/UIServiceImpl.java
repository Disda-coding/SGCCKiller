...
public class UIServiceImpl implements UIService {
    ...
    public void helloWorld() {
        ...
        System.out.println("\n" +
                "                                                                                                                                      \n" +
                "         ______        _____          _____         _____    ____    ____   ____  ____         ____             ______        _____   \n" +
                "     ___|\\     \\   ___|\\    \\     ___|\\    \\    ___|\\    \\  |    |  |    | |    ||    |       |    |        ___|\\     \\   ___|\\    \\  \n" +
                "    |    |\\     \\ /    /\\    \\   /    /\\    \\  /    /\\    \\ |    |  |    | |    ||    |       |    |       |     \\     \\ |    |\\    \\ \n" +
                "    |    |/____/||    |  |____| |    |  |    ||    |  |    ||    | /    // |    ||    |       |    |       |     ,_____/||    | |    |\n" +
                " ___|    \\|   | ||    |    ____ |    |  |____||    |  |____||    |/ _ _//  |    ||    |  ____ |    |  ____ |     \\--'\\_|/|    |/____/ \n" +
                "|    \\    \\___|/ |    |   |    ||    |   ____ |    |   ____ |    |\\    \\'  |    ||    | |    ||    | |    ||     /___/|  |    |\\    \\ \n" +
                "|    |\\     \\    |    |   |_,  ||    |  |    ||    |  |    ||    | \\    \\  |    ||    | |    ||    | |    ||     \\____|\\ |    | |    |\n" +
                "|\\ ___\\|_____|   |\\ ___\\___/  /||\\ ___\\/    /||\\ ___\\/    /||____|  \\____\\ |____||____|/____/||____|/____/||____ '     /||____| |____|\n" +
                "| |    |     |   | |   /____ / || |   /____/ || |   /____/ ||    |   |    ||    ||    |     |||    |     |||    /_____/ ||    | |    |\n" +
                " \\|____|_____|    \\|___|    | /  \\|___|    | / \\|___|    | /|____|   |____||____||____|_____|/|____|_____|/|____|     | /|____| |____|\n" +
                "    \\(    )/        \\( |____|/     \\( |____|/    \\( |____|/   \\(       )/    \\(    \\(    )/     \\(    )/     \\( |_____|/   \\(     )/  \n" +
                "     '    '          '   )/         '   )/        '   )/       '       '      '     '    '       '    '       '    )/       '     '   \n" +
                "                         '              '             '                                                            '                  \n");
